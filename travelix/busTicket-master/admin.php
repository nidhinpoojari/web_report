...
<div class="container">
    ...
    <form action="" method="post">
        <table class="table">
            ...
            <tr>
                <td class="le">Want To Add New Restaurant</td>
                <td><a href="add_restourent.php"><input type="button" value="Add Restaurant"></a></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><a href="add_guid.php"><input type="button" value="Add Guide"></a></td>
            </tr>
            ...
            <tr>
                <td class="le">Want To See all customer details</td>
                <td><a href="customer_details.php"><input type="button" value="Details of customers"></a></td>
            </tr>
